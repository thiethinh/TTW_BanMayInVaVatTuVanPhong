...
<head>
    <meta charset="UTF-8">
    <title>PaperCraft - Thêm Voucher</title>
...
<div class="admin-container">
    ...
    <main class="admin-main-content">
        ...
        <section class="banner-table form-card">
            <form id="form-add" action="admin-voucher" method="post" novalidate>
                ...
                <div class="form-group">
                    ...
                    <textarea name="description" rows="3"
                              placeholder="Mô tả ngắn về voucher..."></textarea>
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="discountValue" name="discountValue"
                           placeholder="0" oninput="onlyNumber(this)"/>
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="quantity" name="quantity"
                           placeholder="0" oninput="onlyInteger(this)"/>
                    <span class="hint">Nhập 0 nếu không giới hạn số lượng.</span>
